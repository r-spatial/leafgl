...
![monthly](http://cranlogs.r-pkg.org/badges/leafgl)![total](http://cranlogs.r-pkg.org/badges/grand-total/leafgl)[![CRAN](http://www.r-pkg.org/badges/version/leafgl?color=009999)](https://cran.r-project.org/package=leafgl)
...
![](reference/figures/pts_blue.png)
...
because it can create color voctors in the blink of an eye!
...
![](reference/figures/pts_viridis.png)
...
![](reference/figures/polys_ch.png)
